...
import { HomeIcon, BellIcon, StarIcon, UsersIcon, MailIcon, SettingsIcon } from './Icons';
    ...
    return (
        <View style={{ position: 'relative', flex: 1 }}>
            <LinearGradient colors={['#F37735', '#F33535']} style={styles.bottomTabs}>
                <TouchableOpacity style={styles.bottomTabsBtn} onPress={() => navigation.push('Home', { animation: 'leftToRight' } )}>
                    <HomeIcon />
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.bottomTabsBtn} onPress={onMainMenuOpenTranslation} >
                    <SettingsIcon />
                </TouchableOpacity>
            </LinearGradient>
