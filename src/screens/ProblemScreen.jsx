...
import { StyleSheet, Text, View, Image, Animated, ImageBackground, TouchableOpacity, Pressable, Easing, Modal } from 'react-native';
...
const ProblemScreen = ({ navigation, route }) => {
    ...
    const defineCorrectAnswer = () => {
        ...
        const answer = operation === 'minus' ? num1Number - num2Number : num1Number + num2Number;
    ...
    checkCorrectAnswer = (val) => {
        val === correctAnswer ? setIsAnswerCorrect(true) : setIsAnswerCorrect(false)
    ...
    const getMenuComponent = () => {
        switch (activeMenu) {
            case 'pink':
                return <PinkPlateMenu style={styles.plateMenu} onItemPress={(val) => { setPlateOne(val); toggleMenuTranslation('pink', 0); }} />;
            case 'orange':
                return <OrangePlateMenu style={styles.plateMenu} onItemPress={(val) => { setPlateTwo(val); toggleMenuTranslation('orange', 0); setNum1(val); console.log(val);}} />;
            case 'yellow':
                return <YellowPlateMenu style={styles.plateMenu} onItemPress={(val) => { setPlateThree(val); toggleMenuTranslation('yellow', 0);}} />;
            case 'blue':
                return <BluePlateMenu style={styles.plateMenu} onItemPress={(val) => { setPlateFour(val); toggleMenuTranslation('blue', 0); }} operation={operation} />;
            case 'green':
                return <GreenPlateMenu style={styles.plateMenu} onItemPress={(val) => { setPlateFive(val); toggleMenuTranslation('green', 0); setNum2(val); console.log(val);}} />;
            default:
                return null;
        }
    };
    ...
    const ColoredButton = ({ source, label, index, onPress, isActive }) => (
        <Animated.View
            style={[
                ...
                { transform: [{ translateX: -155 + (index * 66) }, { translateY: 150 }, { scale: isActive ? scaleAnimation : 1 }] },
            ]}
        >
            <TouchableOpacity
    ...
    return (
        <LinearGradient colors={['#011E57', '#001744']} style={styles.container}>
            ...
            <View style={styles.plate}>
                <ImageBackground source={require('../../assets/plate2.png')} resizeMode="contain" style={{ width: 322, height: 265, paddingHorizontal: 32, paddingVertical: 12 }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <View style={[styles.plateRow]}>
                            {plateOne && (
                                <>
                                    <Image source={imageMap[plateOne]} style={{ width: '25%', height: '100%', resizeMode:'contain' }} />
                            ...
                            {plateOne && plateTwo && (
                                <Image source={numberImageMap[plateTwo]} style={{ width: '15%', height: '100%', resizeMode:'contain', marginLeft: 14 }} />
                            )}

                            {plateOne && plateTwo && plateThree && (
                                <Image source={yellowPlateImageMap[plateThree]} style={{ width: '25%', height: '100%', resizeMode:'contain', marginLeft: 14 }} />
                            )}
                        </View>

                        <View style={[styles.plateRow, { justifyContent: 'center', marginTop: 20 }]}>
                            {plateOne && plateTwo && plateThree && plateFour && plateFive && (
                                <>
                                    <Image source={greenPlateImageMap[plateFive]} style={{ width:'15%', height:'100%', resizeMode:'contain', marginRight:10}} />
                                    <Image source={yellowPlateImageMap[plateThree]} style={{ width: '20%', height: '100%', resizeMode:'contain', marginRight:10}} />
                                </>
                            )}
                            {plateOne && plateTwo && plateThree && plateFour && (
                                <>
                                    <Text style={[styles.plateText, {fontSize:14, width:'35%', marginRight:10}]}>{plateFour}</Text> 
                                    <Image source={bluePlateImageMap[plateFour]} style={{ width: '20%', height: '100%', resizeMode:'contain'}} />
                                </>
                            )}
                        ...
                        {plateOne && plateTwo && plateThree && plateFour && plateFive && (
                            <View style={{ justifyContent: 'center', alignItems: 'center', marginTop: 20 }}>
                                <Text style={[styles.plateText, {textAlign:'center'}]}>How many {plateThree} does {plateOne} have now?</Text>
                            </View>
                        )}
                    </View>
...

            {
                !isResultChecked ?
                    <>
                        <View style={[styles.coloredBtnCont, {
                            transform: [{ translateX: -126 }, { translateY: 210 }]
                        }]}>
                            <TouchableOpacity style={{ width: 55, height: 52 }} onPress={() => {resetAll(), stopResultTransition()}}>
                                <Image source={require('../../assets/sound-btn.png')} style={{ width: 55, height: 52 }} />
                            </TouchableOpacity>
                        </View>

                        <Animated.View style={[styles.coloredBtnCont, {
                            width: 60, height: 60, top: 725,
                            transform: [
                                {
                            ...
                            <TouchableOpacity style={{ width: 60, height: 60 }} onPress={() => {setModalVisible(true); defineCorrectAnswer()}}>
                                <Image source={require('../../assets/guess-btn.png')} style={{ width: 60, height: 60 }} />
                            </TouchableOpacity>
                        </Animated.View>
                        ...
                        >
                            <View style={styles.modalBg}>
                                <ImageBackground source={require('../../assets/plate3.png')} resizeMode="contain" style={styles.numPadModalView}>
                                    <View style={{ width: 360, height: 320, flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', position: 'absolute', top: '50%', left: '50%', transform: [{ translateX: -180 }, { translateY: -160 }] }}>
                                        {numbers.map((number) => (
                                            <TouchableOpacity
                                                key={number}
                                            ...
                                            >
                                                <ImageBackground source={require('../../assets/blue-btn.png')} resizeMode="contain" style={styles.numPadBtn}>
                        ...
                        <View style={[styles.coloredBtnCont, {
                            ...
                            <TouchableOpacity style={{ width: 55, height: 52 }} onPress={() => {setActiveButton(activeButton-1)}}>
                                <Image source={require('../../assets/forward-btn.png')} style={{ width: 55, height: 52, transform: [{ scaleX: -1 }] }} />
                            </TouchableOpacity>
                        </View>
                    </>
                    :
                    isAnswerCorrect ?
                        <Animated.View style={[styles.coloredBtnCont, {
                            ...
                            <TouchableOpacity style={{ width: 42, height: 42 }} onPress={() => { }}>
                                <ImageBackground source={require('../../assets/right-btn.png')} resizeMode="contain" style={{ width: 42, height: 42, alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <Animated.View style={[styles.coloredBtnCont, {
                            ...
                            <TouchableOpacity style={{ width: 42, height: 42 }} onPress={() => { }}>
                                <ImageBackground source={require('../../assets/wrong-btn.png')} resizeMode="contain" style={{ width: 42, height: 42, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Animated.View style={{
                ...
                <Pressable onPress={() => toggleMenuTranslation(activeMenu, 0)} style={{ flex: 1 }}>
                    {getMenuComponent()}
                </Pressable>
            </Animated.View>
