...
import { StyleSheet, Text, View, ImageBackground, SafeAreaView, Image, TextInput, TouchableOpacity, Alert } from 'react-native';
...
const iconList = [
  { id: 'bamboo', source: require('../../assets/bamboo-icon.png'), label: 'bamboo' },
  ...
  { id: 'apple', source: require('../../assets/apple-icon.png'), label: 'apple' },
];
        ...
        <LinearGradient colors={['#011E57', '#001744']} style={styles.container}>
            <ImageBackground source={require('../../assets/gears-background.png')} resizeMode="cover" style={{ flex: 1 }}>
                <SafeAreaView style={{ flex: 1, paddingHorizontal: 20 }}>
                    ...
                    <Text style={[styles.labelText, { marginTop: 110 }]}>This is your user ID:</Text>

                    <View style={styles.iconsRow}>
                        {iconList.map(icon => (
                            <TouchableOpacity key={icon.id} onPress={() => setSelectedIcon(icon.label)}>
                                <Image
                                    source={icon.source}
                                    style={[
                                        styles.iconsRowIcon,
