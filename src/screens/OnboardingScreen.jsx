...
import { StyleSheet, Text, View, ImageBackground, Animated, Image, Easing, TouchableOpacity } from 'react-native';
    ...
    return (
        <LinearGradient colors={['#011E57', '#001744']} style={styles.container}>
            <ImageBackground source={require('../../assets/gears-background.png')} resizeMode="cover" style={{ flex: 1 }}>
                <Animated.View style={[styles.lightningRed, {
                    opacity: opacity.interpolate({
                        inputRange: [0, 1],
                        outputRange: [0, 1],
                    })
                }]}>
                    <Image source={require('../../assets/lightning-red.png')} style={{ width: 52, height: 80, objectFit: 'contain' }} />
                </Animated.View>

                <Animated.View style={[styles.lightningYellow, {
                    opacity: opacity.interpolate({
                        inputRange: [0, 1],
                        outputRange: [1, 0],
                    })
                }]}>
                    <Image source={require('../../assets/lightning-yellow.png')} style={{ width: 61, height: 105, objectFit: 'contain' }} />
                </Animated.View>
                ...
                <Animated.View style={[
                    ...
                    <View style={{ position: 'relative', width: 245, height: 612 }}>
                        <TouchableOpacity onPress={() => navigation.push('IdSignIn')} style={{ position: 'absolute', width: 245, height: 612, top: 0, left: 0, zIndex: 60 }}></TouchableOpacity>
                        ...
                        <Animated.View style={[styles.robot, {
                ...
                <Animated.View style={[styles.bigGear, {
                    transform: [
                        { translateX: -62 },
                        { translateY: 8 },
                        {
                    ...
                    <Image source={require('../../assets/big-gear.png')} style={{ width: 88, height: 88, objectFit: 'contain' }} />
                </Animated.View>

                <Animated.View style={[styles.smallGear, {
                    transform: [
                        { translateX: 12 },
                        { translateY: -52 },
                        {
                    ...
                    <Image source={require('../../assets/small-gear.png')} style={{ width: 48, height: 48, objectFit: 'contain' }} />
                </Animated.View>
